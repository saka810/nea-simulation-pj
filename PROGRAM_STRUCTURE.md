...
プロジェクトフォルダ/条件表.xlsx
  ...
  シート「吸音率」      ← PJ で使う材料の一覧（**番号・材料名・吸音率・種類**）
    番号,材料名,63,125,250,500,1000,2000,4000,8000,種類,備考
    1,スチールドア,0.15,0.29,...,random,
    11,イアルボード96kt25,0.05,0.09,...,random,

  シート「現状」        ← **条件 1 つ ＝ シート 1 枚。シート名が条件名**
    区分,レイヤー名,材料番号,材料名（参考）,面数,面積_m2
    レイヤ,01__研修室_壁_扉,1,=IFERROR(VLOOKUP($C2,吸音率!$A:$B,2,FALSE),""),2,3.255
